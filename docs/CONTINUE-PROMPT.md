...
```
Continue yt-addfree at ~/Documents/reps.nosync/yt-addfree (v1.1.1 on main).
Read docs/SESSION-NOTES.md and CLAUDE.md first.

Shipped in v1.1.0–1.1.1:
...
- Always Ad-Free in ⚙ Settings (default off) + auto-enable on watch
- v1.1.1: toggle no longer double-fires Off (single click + debounce)
...
```
Continue yt-addfree v1.1.1 at ~/Documents/reps.nosync/yt-addfree. Read docs/SESSION-NOTES.md + CLAUDE.md. Build: nvm use 20 && pnpm build → .output/chrome-mv3. Task: <YOUR TASK>
```
